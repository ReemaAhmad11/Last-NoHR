...
function Homepage(){
  ...
  <img src={noaawinLogo} className="header-name-logo" />
    <h2 className="header-name">نعاون للنقل الطبي الإسعافي</h2>
  ...
  <img src={noaawinLogo} className="header-logo" />
     ...
     <Link id="working-schedule" to="/working-schedule"><b>جدول الدوامات</b> <RiTableLine /></Link>

     <div className="salary"> مسير الرواتب</div>
     
     <Link id="table-salary" to="/table-salary"> <b>جدول مسير الرواتب</b><MdAttachMoney /></Link>
     <Link id="Vacation-summary" to="/Vacationsummary"><b>ملخصات الإجازة ونهاية الخدمة</b> <AiOutlineContainer /></Link>
     <Link id="salary-transfer" to="/salary-transfer"> <b>تحويل الرواتب</b>  <BiTransferAlt /></Link>
    ...
    <div className="homepage-box1">
       <h2 className="incoming">الــــــــــــــــوارد <ImMail2 /></h2> 
    </div>
    <div className="homepage-box2">
      <h2 className="reminder">التذكيرات <BiCalendarAlt /></h2>
    </div>
